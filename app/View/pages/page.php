<?php
// 由 app/Controllers/PageController@index 渲染；$article 由控制器注入
?>
            ...
            <div class="row central central-800">
                <div
                    ...
                    <div class="little_texts">
                        <div class="top-title f2"><?php echo $article['articletitle'] ?>
                        ...
                        <div class="info">
                            <span>
                                ...
                                <?php echo $article['articlename'] ?> <i>记录于</i> <?php echo $article['articletime'] ?></span>
                        </div>
