<?php
// 由 app/Controllers/LeavingController@index 渲染
// $leavings（数组）、$leavCount、$jiequ、$Setinfo 由控制器注入
?>
...
<body>
    ...
    <div id="pjax-container">
        ...
        <div class="central central-800 bg">
            ...
            <h3>已收到 <b><?php echo $leavCount ?></b> 条祝福留言<i class="jiequ">（显示最新 <?php echo $jiequ ?>条）</i></h3>

            <div class="row">
                <div class="card col-lg-12 col-md-12 col-sm-12 col-sm-x-12">
                    <?php
                    foreach ($leavings as $item) {
                        $lv_time = $item['time'];
                        $lv_qq = $item['QQ'];
                        $lv_text = $item['text'];
                        $lv_id = $item['id'];
                        ...
                        <div class="leavform <?php if ($Animation == "1") { ?>animated fadeInUp delay-03s<?php } ?>">
                            <div class="textinfo">
                                <div class="MsgTopInfo">
                                    <i class="time" data-tip="<?php echo $datetime = date('Y-m-d H:i:s', $lv_time); ?>" data-tip-position="top">
                                        <?php echo time_tran($lv_time) ?> <b class="yuan"></b>
                                        <?php echo $lv_city ? $lv_city : '未知'; ?>
                                    </i>
                                </div>
                                 <div class="user_info">
                                    <img src="https://q1.qlogo.cn/g?b=qq&nk=<?php echo $lv_qq ?>&s=100">
                                    <div class="head_content">
                                        <div class="level">
                                            访客 <b>#<?php echo $lv_id ?></b>
                                        </div>
                                        <span class="name"><?php echo $lv_name ?></span>

                                    </div>
                                </div>
                                
                                <div class="text"><?php echo escapeXSS($lv_text) ?></div>
                            </div>
                        </div>
                        <?php
                    }
