...
<?php if ($icp <> '' || $copy <> ''): ?>
    <div class="footer-warp">
        <div class="footer">
            <?php if ($icp): ?>
                <p><img src="assets/img/icp.svg"><a href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank"><?php echo $icp ?></a></p>
            <?php endif;
            if ($copy): ?>
                <p><?php echo $copy ?></p>
            <?php endif; ?>
