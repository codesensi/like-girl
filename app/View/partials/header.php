...
-->
<?php
// 本视图由前端控制器 via app/bootstrap.php 注入 $text/$diy/$version 等全局变量。
// 顶部查询 text/diy、include ipjc/ip 的 PHP 块已迁入 app/bootstrap.php。
?>
...
function loadPhotos() {
    ...
    $.post('getPhotos.php', { page: currentPage, limit: limit }, function(res) {
        if (res.code === 200) {
            ...
            FunLazy({
                placeholder: "assets/img/Loading2.gif",
                effect: "show",
...
<meta name="keywords"
    content="<?php echo $text['title'] ?>,Like Girl 5.2.1-Stable,LGNeUi,情侣小站,开源情侣网站,PHP情侣网站,情侣记录,情侣网站,情侣项目,情侣小窝,Love,LikeGirl,Ki,PHP情侣小站,情侣小站使用教程,情侣小站使用文档,情侣小站使用教程,情侣小站使用文档">
...
<link rel="stylesheet" href="assets/css/leaving.css?LikeGirl=<?php echo $version ?>">
<link rel="stylesheet" href="assets/css/index.css?LikeGirl=<?php echo $version ?>">
<link rel="stylesheet" href="assets/css/little.css?LikeGirl=<?php echo $version ?>">
<link rel="stylesheet" href="assets/css/about.css?LikeGirl=<?php echo $version ?>">
<link rel="stylesheet" href="assets/css/animate.min.css">
<link rel="stylesheet" href="assets/vendor/botui/botui.min.css">
<link rel="stylesheet" href="assets/vendor/botui/botui-theme-default.css">
<link rel="stylesheet" href="assets/fonts/font_list/iconfont.css">
<link rel="stylesheet" href="assets/css/loveImg.css?LikeGirl=<?php echo $version ?>">
<link rel="stylesheet" href="assets/css/list.css?LikeGirl=<?php echo $version ?>">
<link rel="stylesheet" href="assets/toastr/toastr.css?LikeGirl=<?php echo $version ?>">
<link rel="stylesheet" href="assets/css/loadinglike.css?LikeGirl=<?php echo $version ?>">
<script src="assets/fonts/font_leav/iconfont.js"></script>
<script src="assets/fonts/font_leav/iconfont.js"></script>
<script src="assets/vendor/botui/botui.min.js"></script>
<script src="assets/js/vue.min.js"></script>
<script src="assets/jquery/jquery.min.js"></script>
<script src="assets/js/jquery.pjax.js" type="text/javascript"></script>
<script src="assets/pagelir/spotlight.bundle.js"></script>
<script src="assets/js/funlazy.min.js"></script>
<script src="assets/js/loading.js?LikeGirl=<?php echo $version ?>"></script>
    ...
    <script>
        ...
        $(document).on('pjax:complete', function () {
            ...
            FunLazy({
                ...
                effect: "show",
                strictLazyMode: false,
                useErrorImagePlaceholder: "assets/img/error.svg"
            })
...
<?php endif; ?>
<script src="assets/js/nprogress.js?LikeGirl=<?php echo $version ?>"></script>
<link href="assets/css/nprogress.css?LikeGirl=<?php echo $version ?>" rel="stylesheet" type="text/css">
<!-- 头部导航条 -->
